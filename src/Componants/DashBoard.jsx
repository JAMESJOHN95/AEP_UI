  ...
  return (
    <>
      <div className='d-flex justify-content-around  parentDiv row  p-2'>
        ...
        <div className=' p-2 col-lg-3 col-md-6 mt-auto mb-auto text-center mt-1 '>
          <DateRange />
      ...
      < div className='text-center mb-3'>
            <button className='btn btn-secondary fw-bolder' onClick={handleCreatePersona}>Create Persona</button>
          </div>
